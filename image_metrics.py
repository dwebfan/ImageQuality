...
if __name__ == '__main__':
    ...
    for dirpath, dirs, files in os.walk(home):
        for filename in files:
            ...
            print("%s(%s) %s %s %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f %0.4f" % (filename, jpgName.suffix, jpgSize, webpSize,
             jpgMetrics["brisque_index"], jpgMetrics["brisque_loss"], webpMetrics["brisque_index"], webpMetrics["brisque_loss"],
             jpgMetrics["content_loss"], webpMetrics["content_loss"],
             jpgMetrics["dists_loss"], webpMetrics["dists_loss"],
             jpgMetrics["fsim_index"], jpgMetrics["fsim_loss"], webpMetrics["fsim_index"], webpMetrics["fsim_loss"],
             jpgMetrics["gmsd_index"], jpgMetrics["gmsd_loss"], webpMetrics["gmsd_index"], webpMetrics["gmsd_loss"],
             jpgMetrics["haarpsi_index"], jpgMetrics["haarpsi_loss"], webpMetrics["haarpsi_index"], webpMetrics["haarpsi_loss"],
             jpgMetrics["lpips_loss"], webpMetrics["lpips_loss"],
             jpgMetrics["mdsi_index"], jpgMetrics["mdsi_loss"], webpMetrics["mdsi_index"], webpMetrics["mdsi_loss"],
             jpgMetrics["ms_ssim_index"], jpgMetrics["ms_ssim_loss"], webpMetrics["ms_ssim_index"], webpMetrics["ms_ssim_loss"],
             jpgMetrics["ms_gmsd_index"], jpgMetrics["ms_gmsd_loss"], webpMetrics["ms_gmsd_index"], webpMetrics["ms_gmsd_loss"],
             jpgMetrics["psnr_index"], webpMetrics["psnr_index"],
             jpgMetrics["pieapp_loss"], webpMetrics["pieapp_loss"],
             jpgMetrics["ssim_index"], jpgMetrics["ssim_loss"], webpMetrics["ssim_index"], webpMetrics["ssim_loss"],
             jpgMetrics["style_loss"], webpMetrics["style_loss"],
             jpgMetrics["tv_index"], jpgMetrics["tv_loss"], webpMetrics["tv_index"], webpMetrics["tv_loss"],
             jpgMetrics["vif_index"], jpgMetrics["vif_loss"], webpMetrics["vif_index"], webpMetrics["vif_loss"],
             jpgMetrics["vsi_index"], jpgMetrics["vsi_loss"], webpMetrics["vsi_index"], webpMetrics["vsi_loss"]))
